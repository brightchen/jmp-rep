...
<s:form name="clientDownloadReportStaticForm" action="ClientDownloadStaticQuarterlyReport" method="post" validate="true">
	<fieldset>
   	<legend><s:text name="quarterlyreport.legend"/></legend>
	<s:token />
