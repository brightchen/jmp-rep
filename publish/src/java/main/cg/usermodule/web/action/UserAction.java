...
import cg.usermodule.service.RoleService;
import cg.usermodule.service.UserService;
import cg.usermodule.web.util.Constants;
import cg.usermodule.web.util.UserUtil;
import cg.usermodule.web.util.Validation;
...
//          user.addRole( getRoleService().getByRolename( currentRoles.get( i ) ) );
      ...
      user.setPassword( UserUtil.encodePassword( password2, "SHA" ) );
  ...
  public String changePassword() throws NoSuchAlgorithmException
  {
    ...
    try
    {
      ...
      if ( isAdminUser( u ) )
      {
        ...
        // check old password
        String encodedOldPassword = UserUtil.encodePassword( inputOldPassword, "SHA" );
      ...
      String encodedPassword = UserUtil.encodePassword( password2, "SHA" );
