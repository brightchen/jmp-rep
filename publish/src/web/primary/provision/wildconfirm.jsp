...
<s:form name="confirmDelProvision" action="deleteProvisionRecord" method="post" validate="true" >
		<s:token />	
		...
		<center><s:text name="provision.confirm.message"/></center>		
		<div class="buttonrow">
			<s:submit action="deleteProvisionRecord" value="Delete" />
			<s:submit action="WildSearchProvision" key="button.cancel" onclick="form.onsubmit=null" />
		</div>
