...
<s:form name="documentDeleteForm" action="DeleteDocument" method="post" validate="true"  enctype="multipart/form-data">
		<fieldset>
...
<authz:authorize ifAnyGranted="operator,publishermgr">	
		...
		<s:submit action="UpdateDocumentInput" key="button.cancel" onclick="form.onsubmit=null" cssClass="fbtn"/>
