...
<s:form name="subscriptionReportStaticForm" action="SubscriptionStaticMonthlyReport" method="post" validate="true">
	<fieldset>
   	<legend><s:text name="subscriptionMonthlyreport.legend"/></legend>
   	<dl>
	<s:token />
