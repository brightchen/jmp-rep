...
<#if parameters.leftTitle?exists><#t/>
	<label for="leftTitle">${parameters.leftTitle}</label>
</#if><#t/>
<div>
	...
	<#if parameters.allowSelectAll?default(true)><#t/>
		...
		<#if parameters.headerKey?exists && parameters.doubleHeaderKey?exists><#t/>
			...
			<#if parameters.buttonCssStyle?exists><#t/>
			 ...
			 value="${selectAllLabel}" onclick="selectAllOptionsExceptSome(document.getElementById('${parameters.id?html}'), 'key', '${parameters.headerKey}');selectAllOptionsExceptSome(document.getElementById('${parameters.doubleId?html}'), 'key', '${parameters.doubleHeaderKey}');<#if parameters.selectAllOnclick?has_content>${parameters.selectAllOnclick};</#if>" />
		<#elseif parameters.headerKey?exists><#t/>
			...
			<#if parameters.buttonCssStyle?exists><#t/>
			 ...
			 value="${selectAllLabel}" onclick="selectAllOptionsExceptSome(document.getElementById('${parameters.id?html}'), 'key', '${parameters.headerKey}');selectAllOptions(document.getElementById('${parameters.doubleId?html}'));<#if parameters.selectAllOnclick?has_content>${parameters.selectAllOnclick};</#if>" />
		<#elseif parameters.doubleHeaderKey?exists><#t/>
			...
			<#if parameters.buttonCssStyle?exists><#t/>
			 ...
			 value="${selectAllLabel}" onclick="selectAllOptions(document.getElementById('${parameters.id?html}'));selectAllOptionsExceptSome(document.getElementById('${parameters.doubleId?html}'), 'key', '${parameters.doubleHeaderKey}');<#if parameters.selectAllOnclick?has_content>${parameters.selectAllOnclick};</#if>" />
		<#else><#t/>
			<input type="button" 
			<#if parameters.buttonCssClass?exists><#t/>
			 class="${parameters.buttonCssClass?html}" 
			...
			<#if parameters.buttonCssStyle?exists><#t/>
			 ...
			 value="${selectAllLabel}" onclick="selectAllOptions(document.getElementById('${parameters.id?html}'));selectAllOptions(document.getElementById('${parameters.doubleId?html}'));<#if parameters.selectAllOnclick?has_content>${parameters.selectAllOnclick};</#if>" />
		</#if><#t/>
	</#if><#t/>

<#if parameters.rightTitle?exists><#t/>
	<label for="rightTitle">${parameters.rightTitle}</label>
</#if><#t/>
<select 
