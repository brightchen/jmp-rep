...
<display:table name="publisherUsers" class="list" requestURI="" id="publisherUserList" export="false" pagesize="10" sort="list">
    <display:column property="username" sortable="true" href="UpdateVirtualPublisherUserInput.do" media="html" paramId="id" paramProperty="id" titleKey="publisherUser.username" />
