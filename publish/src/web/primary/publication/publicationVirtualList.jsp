...
<display:table name="publications" class="list" requestURI="" id="publicationList" export="false" pagesize="10" sort="list">
    <display:column property="publicationname" sortable="true" href="UpdateVirtualPublicationInput.do" media="html" paramId="id" paramProperty="id" titleKey="publication.publicationname" />
